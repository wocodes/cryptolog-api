...
class CreateAssetLogsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('asset_logs', function (Blueprint $table) {
            ...
            $table->decimal('initial_value', 16, 16);
            $table->decimal('current_value', 16, 16)->default(0.0);
            $table->decimal('profit_loss', 16, 16)->default(0.0);
            $table->decimal('24_hr_change', 16, 4)->default(0.0);
            $table->boolean('status')->default(1);
            $table->dateTime('date_bought');
            $table->decimal('roi', 16, 4)->default(0.0);
            $table->decimal('daily_roi', 16, 4)->default(0.0);
            $table->decimal('current_price', 16, 16)->default(0.0);
